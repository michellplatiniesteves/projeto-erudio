...
public class CustomEntityResponseHadler extends ResponseEntityExceptionHandler {
    ...
    public  final ResponseEntity<ExceptionResponse> hadlerUnsupportedMathOperationException(Exception e, WebRequest request){
    ...
    public  final ResponseEntity<ExceptionResponse> IvalidJWTAutenticaationException(Exception e, WebRequest request){
